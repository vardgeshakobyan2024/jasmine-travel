...
const AccordionParent = () => {
    const accordionData = [
        ...
        },
        {
            ...
            items: [
                "Եգիպտոս ուղղության հետ ծանոթացում,լավագույն հյուրանոցները,փաթեթների կազմում",
                "ԱՄԷ ուղղության հետ ծանոթացում,լավագույն հյուրանոցները,փաթեթների կազմում",
                "Կիպրոս ուղղության հետ ծանոթացում,լավագույն հյուրանոցները,փաթեթների կազմում"
            ],
            price: " 25.000 Դրամ"
        },
        {
